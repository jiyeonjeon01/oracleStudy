...
ALTER TABLE STUDENT ADD CONSTRAINT STUDENT_JUMIN_UK UNIQUE (JUMINNO);
ALTER TABLE STUDENT ADD CONSTRAINT STUDENT_EMAIL_UK UNIQUE (EMAIL);
ALTER TABLE STUDENT ADD CONSTRAINT STUDNET_SUBJECT_NUM_FK FOREIGN KEY(NUM)
REFERENCES SUBJECT (NUM);

SELECT *
FROM USER_CONSTRAINTS
WHERE TABLE_NAME='STUDENT' AND CONSTRAINT_TYPE!='C';
